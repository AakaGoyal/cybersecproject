...
<style>
  ...
  /* Question (bigger) + explanation (smaller, italic) */
...
# radio helper: emoji UI, plain values stored
...
# ─────────────────────────────────────────────────────────────
def section(title_id, qlist): return {"id":title_id, "title":title_id, "questions":qlist}
SECTION_3 = section("Access & Identity", [
    ...
    {"id":"ai_mfa","t":"🔐 Is Multi-Factor Authentication (MFA) enabled for key accounts?","h":"Authenticator app or security key. Start with email, admin, finance."},
...
SECTION_4 = section("Device & Data", [
    {"id":"dd_lock","t":"🔒 Are all laptops/phones protected with a password or PIN?","h":"Enable auto-lock (≤10 minutes) and find-my-device."},
    ...
    {"id":"dd_edr","t":"🛡️ Is reputable antivirus/EDR installed and active on all devices?","h":"Examples: Microsoft Defender, CrowdStrike, SentinelOne."},
...
SECTION_6 = section("Incident Preparedness", [
    ...
    {"id":"ip_log","t":"📝 Are incident details recorded when they occur?","h":"What/when/who/impact; a ticket template helps."},
    {"id":"ip_contacts","t":"📞 Are key contacts known for emergencies?","h":"Internal IT, MSP, cyber insurer, legal, DPO/contact."},
...
SECTION_7 = section("Vendor & Cloud", [
    ...
    {"id":"vc_access","t":"🧾 Do you track which suppliers have access to systems/data?","h":"Maintain a list; remove unused integrations."},
...
if st.session_state.page == "Step 1":
    ...
    st.caption("Just the basics — detailed bits come later.")
...
if st.session_state.page == "Step 2":
    ...
    with body:
        ...
        with tab2:
            ...
            st.markdown("<div class='q'>✉️ Q7. Do you use business email addresses (e.g., info@yourcompany.com)?</div>", unsafe_allow_html=True)
            ...
            st.markdown("<div class='q'>🔎 Q9. Do you regularly review what’s public about the company or staff?</div>", unsafe_allow_html=True)
        ...
        with tab3:
            ...
            with cA:
                ...
                st.radio("🏗️ Primary work environment", WORK_ENVIRONMENTS, key="primary_work_env", horizontal=True,
                         index=WORK_ENVIRONMENTS.index(st.session_state.primary_work_env))
                st.radio("🏠 Remote work ratio", REMOTE_RATIO, key="remote_ratio", horizontal=True,
            ...
            with cB:
                ...
                st.radio("🌐 Cross-border data flows", CROSS_BORDER, key="cross_border", horizontal=True,
...
# ─────────────────────────────────────────────────────────────
# STEP 4 — Detailed (dynamic progress)
# ─────────────────────────────────────────────────────────────
